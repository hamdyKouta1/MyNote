...
class OpenNoteBySearch extends StatefulWidget {
  const OpenNoteBySearch({Key? key}) : super(key: key);

  @override
  State<OpenNoteBySearch> createState() => _OpenNoteBySearch();
}

class _OpenNoteBySearch extends State<OpenNoteBySearch> {
                    ...
                    child: Form(
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                db!.deleteData(check: data[goBySearch]['id']);
                                print("object");
                                setState(() {
                                  Navigator.push(
                                    context,
